defmodule FoodTruckBotWeb.Router do
  use FoodTruckBotWeb, :router
  ...
  # scope "/api", FoodTruckBotWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:food_truck_bot, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: FoodTruckBotWeb.Telemetry
