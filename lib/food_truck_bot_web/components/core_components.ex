defmodule FoodTruckBotWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FoodTruckBotWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FoodTruckBotWeb.Gettext, "errors", msg, opts)
    end
  end
