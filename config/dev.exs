...
config :food_truck_bot, FoodTruckBot.Repo,
  ...
  database: System.get_env("DATABASE_DB") || "food_truck_bot_dev",
  stacktrace: true,
...
config :food_truck_bot, FoodTruckBotWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "+/du6aWttXJSe6f9x4KQ9hC6jyXb72xIgMGwZW2PRK3qBvfpMkTxJH+ZHsrhxr4H",
  watchers: [
...
config :food_truck_bot, FoodTruckBotWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/food_truck_bot_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :food_truck_bot, dev_routes: true
